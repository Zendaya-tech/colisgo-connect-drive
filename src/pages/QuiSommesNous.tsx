          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-100 rounded-2xl p-6">
              ...
              <p className="mt-3 text-muted-foreground">
                Rendre la livraison plus simple, plus verte et plus accessible
                en s’appuyant sur les trajets existants.
              </p>
            </div>
            <div className="bg-gray-100 rounded-2xl p-6">
              <h3 className="text-xl font-semibold">Nos valeurs</h3>
              <p className="mt-3 text-muted-foreground">
                Confiance, transparence et sécurité. Chaque échange est
                sécurisé, tracé et assuré.
              </p>
            </div>
            <div className="bg-gray-100 rounded-2xl p-6">
              <h3 className="text-xl font-semibold">Notre vision</h3>
              <p className="mt-3 text-muted-foreground">
                Construire le plus grand réseau de livraison collaborative en
                Dollarpe, porté par sa communauté.
              </p>
            </div>
          </div>
        </div>
