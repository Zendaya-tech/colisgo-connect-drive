...
export default function FeaturedProperties() {
    const travelers = [
        {
            ...
            price: "15€/kg",
            rating: "4.8",
            image: "https://images.unsplash.com/photo-1510915228340-29c85a43dcfe?w=400&h=300&fit=crop&crop=face",
            weight: "8kg",
    ...
    return (
        <section className="pb-12 pt-4 px-4 mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Les Dernieres <span className="text-orange-600">Annonces</span></h2>
