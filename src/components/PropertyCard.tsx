...
export default function PropertyCard({ name, location, price, type, rating, image, featured = false, weight, departure, airline, isRequest = false, avatar }: PropertyCardProps) {
    ...
    return (
        <Link to={`/announces/${"9"}`} className="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden px-2 py-3  transition-shadow border border-gray-200 dark:border-gray-800">
