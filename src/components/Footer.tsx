        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#fonctionnement" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-smooth">Fonctionnement</a></li>
              <li><a href="#avantages" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-smooth">Avantages</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-smooth">Centre d'aide</a></li>
              <li><a href="#" className="text-secondary-foreground/80 hover:text-secondary-foreground transition-smooth">FAQ</a></li>
