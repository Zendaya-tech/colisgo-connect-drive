      ...
      <div className="relative bg-gray-900 rounded-2xl overflow-hidden h-80 group cursor-pointer">
        ...
        <div className="absolute inset-0 flex flex-col justify-between py-3 px-3 bg-black/40 group-hover:bg-black/30 transition-colors">
          ...
          <div className="flex gap-2">
            <button className="bg-orange-600 hover:bg-orange-700 text-sm  text-white px-4 py-2 rounded-lg">
              {t("home.recommendations.explore")}
            </button>
            <button
              ...
              <div className="">
                ...
                >
                  <iframe
                    ...
                    src={
                      /*videoUrl || */ "https://www.youtube.com/embed/wyTfWvtGSSY?si=A8pZ_Bisr8_CUSlK&autoplay=1"
                    }
